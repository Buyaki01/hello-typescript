...
const myImg = document.getElementById('#img'); // We can now remove the !, non-null assertion
const nextImg = document.getElementById('#img'); // Though this way will not work in tsx files for React
myImg.src;
